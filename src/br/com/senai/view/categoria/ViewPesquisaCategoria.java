...
public class ViewPesquisaCategoria extends JFrame {
	...
	public ViewPesquisaCategoria() {
		...
		btnListar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					String filtroInformado = txtFiltro.getText();
					List<Categoria> categoriaEncontrada = service.listarPor(filtroInformado);
